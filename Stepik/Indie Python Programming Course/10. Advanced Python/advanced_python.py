...
# 477. Кто не помнит со школьных уроков английского эту запоминашку для написания английских слов, таких как например bought.
...
print(any(c.endswith('ought') for c in input().lower().split()))