...
# Напишите функцию make_strings_big, которая должна принимать произвольное количество фраз и выводить каждую в отдельной строке, превращая все буквы в заглавные.
