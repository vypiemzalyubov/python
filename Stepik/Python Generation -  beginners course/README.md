...
В Python есть набор **ключевых слов**, которые являются **зарезервированными словами**. Эти слова нельзя использовать в качестве имен переменных, имен функций или любых других идентификаторов [Python Keywords|https://www.w3schools.com/python/python_ref_keywords.asp]
