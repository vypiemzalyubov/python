...
match = re.sub(fr"({a}[а-яё]*\s{b[0]}\.\s{c[0]}\.)|({a}[а-яё]*\s{b[0:3]}[^\s]*\s{c[0:3]}[^\s]*\s)", 'ФИО', input())
print(match)

# 96. Удалите все знаки препинания из текста и выведите количество совершённых замен.
...
pattern = r'[.?!,:]'
match = re.subn(pattern, '', input())
print(match[-1])

# 97. Замените все цифры на X. Выведите полученную строку и количество совершённых замен.
