...
**Комп. языки** (С, С++, Паскаль): программа переводится в машинный код целиком. 
Это выполняет **компилятор**.

**Интерп. языки** (Пайтон, Руби, ПХП): программа переводится в машинный код построчно. 
...
По-умолчанию между двумя pint() программа выводит **перенос строки.** 
